(() => {
  ...
  const sliders = {
    trajectory: document.getElementById('trajectorySlider'),
    dimension: document.getElementById('dimensionSlider'),
    extension: document.getElementById('extensionSlider'),
    recombination: document.getElementById('recombinationSlider')
  };

  const outputs = {
    trajectory: document.getElementById('trajectoryOutput'),
    dimension: document.getElementById('dimensionOutput'),
    extension: document.getElementById('extensionOutput'),
    recombination: document.getElementById('recombinationOutput')
  };

  const rotateButton = document.getElementById('rotateButton');
  const resetButton = document.getElementById('resetButton');
  const labelNodes = [...document.querySelectorAll('#stageLabels span')];

  const ui = {
    stageTag: document.getElementById('stageTag'),
    phase: document.getElementById('phase'),
    descriptor: document.getElementById('descriptor'),
    shapeTitle: document.getElementById('shapeTitle'),
    description: document.getElementById('description'),
    dimensionMetric: document.getElementById('dimensionMetric'),
    vertexMetric: document.getElementById('vertexMetric'),
